...
def generate_circuit(
    *,
    ...
    return generate_tile_code_circuit(params, is_memory_x=False)
...
def main() -> None:
    ...
    filename = f"parallel_special_TILE_Z_logical_error_round8_open_rates_l{l}_m{m}_bias{int(bias)}.csv"
