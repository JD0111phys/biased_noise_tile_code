# Linear-deformation tile code - Z memory
...
def finish_surface_code_circuit(
    ...
    params.append_measure(tail, data_qubits, "X" if is_memory_x else "Z")
...
def main():
    ...
    filename = f"parallel_special_TILE_linear_Z_memory_logical_error_round8_open_rates_l{l}_m{m}_bias{int(bias)}.csv"
